...
$sql=$con->query("INSERT INTO stock(drug_name,category,description,company,supplier,quantity,cost,status,date_supplied)
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/hd_logo.jpg"></a> Pharmacy Management Sysytem</h1></div>
<div id="left_column">
<div id="button">
<ul>
...
<hr/>	
    <div class="tabbed_area">  
		...
		*/
        ...
        $result = $con->query("SELECT * FROM stock") 
                or die(mysql_error());
